  ...
  <header class="header"  >
      <div class="container">
        ...
        <div class="float--right flex align-items--center" v-else>
          <nav class="nav">
            <!--<a href="/">平台首页</a>-->
            <a href="http://dev0.hxmec.com/static/of/index.html">返回首页</a>
...
export default {
  ...
  data() {
    return {
      ...
      logo: require('../assets/images/logol.png'),
  ...
  methods: {
    ...
    getUnLoginInfohf() {
        ...
        if(url.indexOf("fj.html")!=-1){
          this.logo = require('../assets/images/logol.png')
          this.showT = false
          //console.log("showT: "+this.showT)
        }
